...
//ol.proj.get("EPSG:4326").setExtent([-188.999988, -103.043405, 188.999988, 128.168396]);
var wms_layers = [];
...
lyr_Worldmap_0.set('fieldLabels', {'FID_1': 'hidden field', 'COUNTRY': 'hidden field', 'ISO': 'hidden field', 'COUNTRYAFF': 'hidden field', 'AFF_ISO': 'hidden field', 'SHAPE_Leng': 'hidden field', 'SHAPE_Area': 'hidden field', });
lyr_2100SSP585_1.set('fieldLabels', {'ID': 'hidden field', 'Name': 'header label - always visible', 'Country1': 'hidden field', 'Country2': 'hidden field', 'Continent': 'hidden field', 'Area_sqkm': 'hidden field', 'Baseline': 'hidden field', 'ssp126_50': 'hidden field', 'ssp585_50': 'hidden field', 'ssp126_00': 'hidden field', 'ssp585_00': 'header label - always visible', });
lyr_2100SSP126_2.set('fieldLabels', {'ID': 'hidden field', 'Name': 'header label - always visible', 'Country1': 'hidden field', 'Country2': 'hidden field', 'Continent': 'hidden field', 'Area_sqkm': 'hidden field', 'Baseline': 'hidden field', 'ssp126_50': 'hidden field', 'ssp585_50': 'header label - always visible', 'ssp126_00': 'header label - always visible', 'ssp585_00': 'hidden field', });
lyr_2050SSP585_3.set('fieldLabels', {'ID': 'hidden field', 'Name': 'header label - always visible', 'Country1': 'hidden field', 'Country2': 'hidden field', 'Continent': 'hidden field', 'Area_sqkm': 'hidden field', 'Baseline': 'hidden field', 'ssp126_50': 'header label - always visible', 'ssp585_50': 'hidden field', 'ssp126_00': 'hidden field', 'ssp585_00': 'hidden field', });
lyr_2050SSP126_4.set('fieldLabels', {'ID': 'hidden field', 'Name': 'header label - always visible', 'Country1': 'hidden field', 'Country2': 'hidden field', 'Continent': 'hidden field', 'Area_sqkm': 'hidden field', 'Baseline': 'hidden field', 'ssp126_50': 'header label - always visible', 'ssp585_50': 'hidden field', 'ssp126_00': 'hidden field', 'ssp585_00': 'hidden field', });
lyr_Baseline_5.set('fieldLabels', {'ID': 'hidden field', 'Name': 'header label - always visible', 'Country1': 'hidden field', 'Country2': 'hidden field', 'Continent': 'hidden field', 'Area_sqkm': 'hidden field', 'Baseline': 'header label - always visible', 'ssp126_50': 'hidden field', 'ssp585_50': 'hidden field', 'ssp126_00': 'hidden field', 'ssp585_00': 'hidden field', });
